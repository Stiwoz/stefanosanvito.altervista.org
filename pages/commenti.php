            ...
            <div class="col-md-5">
                <form class="comment-form" id="commForm" name="commForm" method="get" action="../queries/sendform.php">
                    ...
                    <div class="form-group sr-only">
                        <input type="text" class="form-control" name="city" id="city" placeholder="city"/><span id="cityerr" class="error">Sei un bot!</span>
                    </div>
                    <div class="form-group">
                        <div class="row">
                    ...
                    <strong>Autorizzo il trattamento dei miei dati personali ai sensi del <a href="http://www.camera.it/parlam/leggi/deleghe/03196dl.htm" target="_blank">D.lgs. 196 del 30 giugno 2003</a></strong>
                        ...
                        <div class="center-block">
                            ...
                            <button id="reset" type="reset" class="button-cancel">Cancella</button>
                        </div>
                    </div>
                </form>
                <!---<div class="hidden-xs">
